...
@section('titulo')
    Reporte de Horarios mas Solicitados
@endsection
...
@section('panelIzq')
    <div class="nav-item">
        ...
        <div class="row">
            <div class="col-sm-6">
                <form method="post" action="{{route('reporte.horario-top')}}" target="_blank">
                    {{csrf_field()}}
...
@section('titulo_contenido')
    <div class="row">
        <div class="col-sm-9">
            <h3 class="card-title">Reporte de Horarios mas Solicitados</h3>
        </div>
        <div class="col-sm-3">
    ...
    <ul class="list-group">
        @foreach($info as $horarios)
            <li class="list-group-item row">
                ...
                <div class="col-sm-4">
                    {{'Veces Solicitado ' .$horarios->usos_count}}
                </div>
            </li>
        @endforeach
    </ul>
