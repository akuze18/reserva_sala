...
@section('titulo_contenido')
    <div class="row">
        <div class="col-sm-9">
            <h3 class="card-title">Asignar Carga Academica</h3>
        </div>
        <div class="col-sm-3">
...
@section('contenido')
    <div class="text-center">
        <form class="form" method="post" action="{{route('CA.store')}}">
            {{ csrf_field() }}
            ...
            @include('marco.form.select',fData('asignatura_id',null,$asignaturas))
            @include('marco.form.select',fData('edificio_id',null,$edificios))
            @include('marco.form.select',fData('piso_id',null,$pisos))
            @include('marco.form.select',fData('sala_id',null,$salas))
